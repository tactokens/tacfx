...
public class ApplicationSettings {
    public final static AssetDetails MAIN_TOKEN = new AssetDetails("TAC", 0L, 0L, "", "Tac", "", 8, false, 10000000000000000L, false, 100000L);
    ...
    public final static String CUSTOM_NODE = "http://127.0.0.1:6860";
    ...
    public final static String STAGENET_NODE ="http://127.0.0.1";
    public final static String TESTNET_NODE = "http://127.0.0.1";
